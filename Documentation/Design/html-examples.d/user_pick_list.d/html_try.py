...
users = [
    ...
    dict(clan="Birdsall", id="benjamin", dname="Benjamin Birdsall"),
    dict(clan="Kirkup", id="benjamin", dname="Benjamin Birdsall"),
    dict(clan="Kirkup", id="blaine", dname="Blaine Vernal"),
    ...
    dict(clan="Kirkup", id="diane", dname="Diane Vernal"),
    ...
    dict(clan="Birdsall", id="mike", dname="Michael Gerald Birdsall"),
   dict(clan="Kirkup", id="mike", dname="Michael Gerald Birdsall"),
    ...
    dict(clan="Birdsall", id="sue", dname="Susan Kirkup"),
     dict(clan="Kirkup", id="sue", dname="Susan Kirkup"),
